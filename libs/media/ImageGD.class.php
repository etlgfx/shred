...
/**
 * @class ImageGD implements the AbstractImage interface / class. simple image
 * operations like resizing and cropping are thus standardized
 *
 * @see AbstractImage
 */
class ImageGD extends AbstractImage {
	private $im;
	private $target_im;
	...
	public function openImpl($filename) {
		$this->im = imagecreatefromstring(file_get_contents($filename));
